...
export const TRANSLATIONS = {
  en: {
    ...
    syncing: "Syncing...",
    syncSuccess: "Events imported!",
    syncError: "Sync failed. Check Client ID.",
    birdEye: "Bird-Eye",
    viewMode: "View Mode",
    layout: "Layout",
    fadePast: "Fade Past",
  ...
  it: {
    ...
    syncSuccess: "Eventi importati!",
    syncError: "Errore. Verifica Client ID.",
    birdEye: "Panoramica",
